...
- summary: связный текст на языке выходного формата (max 380 символов): о чём в основном пишут, радуются/спорят/жалуются, главный вывод. Без эмодзи, markdown, маркерных списков — сплошной текст.`;
